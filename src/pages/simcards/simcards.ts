...
export class SimcardsPage {
  ...
  constructor(public renderer: Renderer, private toast: ToastController, public viewCtrl: ViewController, public navCtrl: NavController, public navParams: NavParams) {
    let _base = this;
